...
const t = {
  ...
  ES: {
    ...
    heroSub: 'Mitad noruego, mitad argentino. Opero en Forex, construyo una comunidad en tres idiomas y enseño todo lo que sé. Sin exclusividades.',
    ...
    storyP2: 'Empecé a operar en Forex hace unos 5 años. Cometí errores, aprendí rápido y, con el tiempo, conseguí crear una comunidad de seguidores en TikTok, Snapchat e Instagram, donde enseño a otros lo que me hubiera gustado saber.',
...
export default function Home() {
  ...
  const handleCheckout = async (product) => {
    if (!user) { navigate("/checkout?product=" + product); return; }
    try {
